...
class App extends Component{
  ...
  constructor(props){
    ...
    this.frases = [
      ...
      'Tem gente que esquece que você não precisa diminuir o outro para crescer.',
      'O ataque pessoal é a falência da razão.',
  ...
  quebraBiscoito(){
    ...
    this.setState({
     ...
     //definir atraso para o biscoito fechar dnv
     setTimeout(() => {
      this.setState({
        textoFrase: '',
        img: require('./assets/biscoito.png'),
